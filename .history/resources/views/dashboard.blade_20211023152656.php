            ...
            <div class="flex flex-col bg-black bg-opacity-30 rounded-md mb-8 shadow-md">
                <div class="flex items-center w-full px-6 py-4 text-white text-sm font-semibold uppercase tracking-wider" style="font-family: 'Roboto', sans-serif">
                    ...
                    <div class="flex items-center ml-auto">
                        <button type="button" id="prev-announcement" class="mr-3 uppercase">Prev</button>
                        <button type="button" id="next-announcement" class="uppercase">Next</button>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="flex flex-col bg-white bg-opacity-5 rounded-b-md">
                        ...
                        <h2 class="text-gray-300 italic font-semibold px-6 pb-3">~ Brandon Rooney</h2>
                    </div>
                </div>
            </div>
