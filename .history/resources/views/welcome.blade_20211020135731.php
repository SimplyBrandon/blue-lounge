    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex items-start px-96 h-screen" style="background-color: #201E1F">
                <div class="rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px; background-color: #111">
                    <div class="h-1/2">
                        <h2 class="text-white text-4xl font-light mb-10 uppercase">Get In Touch</h2>
                        <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                            <div class="flex items-start">
                                <label class="font-semibold text-sm mt-3 uppercase text-white" style="width: 130px" for="name">Your Name</label>
                                <input class="border border-gray-800 flex-grow bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name">
                            </div>
                            <div class="flex items-start mt-8">
                                <label class="font-semibold text-sm mt-3 uppercase text-white" style="width: 130px" for="name">The Subject</label>
                                <input class="border border-gray-800 flex-grow bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name">
                            </div>
                            <div class="flex items-start mt-8">
                                <label class="font-semibold text-sm mt-3 uppercase text-white" style="width: 130px" for="name">The Message</label>
                                <textarea style="font-family: 'Nunito', sans-serif; height: 145px" class="border border-gray-800 resize-none flex-grow bg-black bg-opacity-50 p-3 rounded-md" name="name" id="name"></textarea>
                            </div>
                            <div class="flex flex-col items-end">
                                <button type="button" class="bg-white bg-opacity-5 rounded-md mt-5 px-6 py-3 text-gray-400 uppercase text-sm tracking-wider"><i class="fa fa-paper-plane mr-5"></i> Submit</button>
                            </div>
                        </form>
                    </div>
                    <div class="h-1/2">
