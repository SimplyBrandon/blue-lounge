        ...
        <div class="flex items-start justify-between px-96 py-64 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            <div class="flex items-center justify-between w-full">
                <div class="flex flex-col">
                    ...
                    <p class="text-xl text-gray-300 mb-4">Since we opened in 2001 we've cultivated a unique and friendly environment with modern decor, a resident DJ and events.</p>
