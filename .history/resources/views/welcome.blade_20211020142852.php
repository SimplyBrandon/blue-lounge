            ...
            <div class="flex flex-col bg-black px-96 py-12">
                <div class="flex items-start">
                    <div class="flex flex-col">
                        ...
                        <p class="text-gray-300 leading-5 text-md tracking-wide" style="width: 205px">Redcar's finest cocktail bar is ready to provide you with an outing you won't forget!</p>
