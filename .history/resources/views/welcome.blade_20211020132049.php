        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-start px-96 h-screen">
                <div class="bg-gray-900 rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300" style="height: 1000px">
                    <h2 class="font-semibold text-white text-4xl font-light">Contact Form</h2>
                </div>

                <div class="flex flex-col h-full w-1/2" style="height: 1000px">
                    <img class="rounded-r-3xl" height="100%" width="100%" src="{{ asset('img/contact-bg.png') }}"/>
                </div>
            ...
            <div class="flex items-start px-96 pt-80 -mx-4 h-screen">
                ...
                <div class="rounded-3xl overflow-hidden w-1/2" style="background-image: url('{{ asset('img/contact-bg.png') }}')">
                    <iframe width="100%" height="585" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCKJ5j9soePYzu_RWTE3GxkwJ2o7IA3PMY&q=Blue,Lounge,Redcar"></iframe>
