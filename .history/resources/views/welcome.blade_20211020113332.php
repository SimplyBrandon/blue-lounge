            ...
            <div class="flex flex-col bg-white py-24 px-96">
                ...
                <div class="flex flex-col mt-12">
                    ...
                    <div class="flex items-center -mx-4">
                        ...
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md">
                                <p class="leading-7">Tom and Ellie have delivered to excellent service. Such friendly and lovely people, helped me out when my phone was dead and helped me contact family members so I wasn’t on my own. Really appreciate their customer service, really friendly and polite. Wouldn’t recommend anymore xx</p>
