...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex flex-col items-center px-96 pt-80 h-screen parallax-window" data-parallax="scroll" data-image-src="{{ asset('img/website_bg_2.png') }}" style="background-size: cover;" >
                <div class="masonry-with-columns" id="masonry-with-columns">
                    <div class="flex flex-col">
                        <img style="width: 20%" src="{{ asset('img/banner.jpg') }}"/>
                    </div>
                    <div class="flex flex-col">
                        <img style="width: 80%" src="{{ asset('img/banner.jpg') }}"/>
                    </div>
                </div>
            </div>
        </div>
