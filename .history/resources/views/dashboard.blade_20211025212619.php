    ...
    <div class="flex flex-col max-w-7xl mx-auto px-4 pt-12 sm:px-6 lg:px-8">
        <div class="flex items-center">
            ...
            <div class="flex flex-col ml-10">
                ...
                <h2 class="text-red-400 text-xl mt-1 tracking-wider" style="font-family: 'Quicksand', sans-serif">Manager <span class="ml-3 text-sm text-gray-300">Since 25/10/2021</span></h2>    
            </div>
        </div>
