                    ...
                    <div class="rounded-tl-3xl h-4/5 p-24" style="background-color: #111">
                        ...
                        <form class="contact-form" style="font-family: 'Roboto', sans-serif">
                            ...
                            <div class="flex items-center justify-between mt-8">
                                <p class="text-gray-500">By submitting a message you agree to our <a class="text-gray-300" href="#">Privacy Policy</a> and <a class="text-gray-300" href="#">Terms of Service</a></p>
