                ...
                <div class="rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px; background-color: #111">
                    ...
                    <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                        <div class="flex items-start">
                            ...
                            <input class="border border-gray-50 flex-grow bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name">
                        </div>
                        ...
                        <div class="flex items-start mt-8">
                            ...
                            <textarea style="font-family: 'Nunito', sans-serif; height: 145px" class="border border-gray-50 resize-none flex-grow bg-black bg-opacity-50 p-3 rounded-md" name="name" id="name"></textarea>
                        </div>
