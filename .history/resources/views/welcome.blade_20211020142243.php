...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex flex-col pt-24 px-96 text-gray-300" style="background-color: #201E1F">
            ...
            <div class="flex flex-col bg-white px-96 py-5">
                <h2 class="font-bold">&copy; Blue Lounge 2021</h2>
            </div>
        </div>
