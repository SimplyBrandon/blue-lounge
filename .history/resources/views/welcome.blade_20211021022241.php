    ...
    <body class="antialiased bg-gray-800" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex items-center px-96 h-screen" style="background-color: #201E1F">
                <div class="flex flex-col h-full w-1/2 text-gray-300 border border-gray-600 shadow-lg" style="height: 1000px;">
                    <div class="rounded-tl-3xl h-4/5 p-24 bg-black bg-opacity-20">
                    ...
                    <div class="rounded-bl-3xl h-1/5 px-24 flex flex-col justify-center text-3xl text-white" style="background-color: #000">
