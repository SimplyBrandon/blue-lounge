            ...
            <div class="flex flex-col bg-black bg-opacity-30 rounded-md mb-8 shadow-md">
                <div class="flex items-center w-full px-6 py-4 text-white text-sm font-semibold uppercase tracking-wider" style="font-family: 'Roboto', sans-serif">
                    ...
                    <div class="flex items-center ml-auto">
                        ...
                        <button type="button" id="prev-announcement" class="mr-3 uppercase font-semibold">Prev</button>
    ...
    <script>
        $(document).ready(function(){
            $('body').on('click', function(){
                ...
                var announcementWidth = $('#staff-announcements').find('.bg-white')[0].outerWidth();

                console.log(announcementWidth);
                $("#staff-announcements").animate({scrollLeft: announcementsLeftPos - 200}, 800);
            });
        });
