...
@section('content')
    <div class="flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center py-12 px-12" style="background: rgb(0,0,0);
background: linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(17,24,39,1) 100%);">
            <img style="height: 100px; width: 100px" class="rounded-3xl shadow-2xl border-2 border-gray-300 border-opacity-20" src="https://scontent-lcy1-2.xx.fbcdn.net/v/t1.6435-9/84535118_2234335966869824_9114908075222892544_n.jpg?_nc_cat=109&ccb=1-5&_nc_sid=174925&_nc_ohc=PrEuIakgkSUAX-vH-My&_nc_oc=AQl756Ga_89dfl1ea04bhESo-M_UvA54eUZ44fY09oV9l0hgbeK2ZOpLk8ZycNZk9_Q&_nc_ht=scontent-lcy1-2.xx&oh=06b37e2e49cc5251256a60e1cdaee3e6&oe=619D74C0"/>
            <div class="flex flex-col ml-10">
                <h1 class="text-3xl text-white">Welcome back, <strong>{{ Auth::user()->name }}</strong>.</h1>
                <h2 class="text-red-400 text-xl mt-1 tracking-wider flex items-center" style="font-family: 'Quicksand', sans-serif">Manager <span class="text-sm text-gray-300 ml-3">Since 25/10/2021</span></h2>
            </div>
        </div>
    ...
    <div class="flex items-start max-w-7xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col flex-grow mr-10">
            ...
            <div class="flex items-center mb-10 gap-4">
                <div class="flex items-center bg-white bg-opacity-5 rounded-md p-6 w-1/3">
                    <i class="fa fa-clock-o text-4xl text-white mr-4"></i>
                    <div class="flex flex-col">
                        <h1 class="text-xl text-white font-bold">1,040</h1>
                        <h2 class="text-sm font-semibold text-gray-500">Total Hours Clocked</h2>
                    </div>
                </div>
                <div class="flex items-center bg-white bg-opacity-5 rounded-md p-6 w-1/3">
                    <i class="fa fa-money text-4xl text-white mr-4"></i>
                    <div class="flex flex-col">
                        <h1 class="text-xl text-white font-bold">£6,864</h1>
                        <h2 class="text-sm font-semibold text-gray-500">Total Earnings</h2>
                    </div>
                </div>
                <div class="flex items-center bg-white bg-opacity-5 rounded-md p-6 w-1/3">
                    <i class="fa fa-calendar text-4xl text-white mr-4"></i>
                    <div class="flex flex-col">
                        <h1 class="text-xl text-white font-bold">204</h1>
                        <h2 class="text-sm font-semibold text-gray-500">Total Days Worked</h2>
                    </div>
                </div>
            </div>
