    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <header class="absolute w-full flex items-center justify-between py-16 px-96">
            ...
            <nav class="flex items-center">
                <a class="text-lg uppercase text-gray-300 mr-14 shadow-md" href="#">About</a>
                <a class="text-lg uppercase  text-gray-300 mr-14 shadow-md" href="#">Gallery</a>
                <a class="text-lg uppercase  text-gray-300 mr-14 shadow-md" href="#">Events</a>
