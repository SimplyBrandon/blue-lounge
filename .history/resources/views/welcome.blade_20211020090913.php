...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex flex-col px-96 py-36 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            <div class="flex items-center justify-between w-full bg-white p-6 rounded-md shadow-lg" style="font-family: 'Nunito', sans-serif">
                <div class="flex flex-col">
                    <h2 class="text-black mb-7 text-3xl font-bold uppercase tracking-wide" style="font-family: 'Nunito', sans-serif">Welcome to Blue Lounge</h2>
                    <p class="text-xl text-gray-600 mb-3">Since we opened in 2001 we've cultivated a unique and friendly environment with modern decor, a resident DJ and events.</p>
                    <p class="text-xl text-gray-600">We pride ourselves in providing a safe space with a welcoming atmosphere for everyone to have fun!</p>
                </div>
