        ...
        <div class="flex flex-col px-96 py-64 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            ...
            <div class="flex items-center justify-between w-full" style="font-family: 'Nunito', sans-serif">
                ...
                <div class="flex items-center">
                    <a class="border-2 border-white px-6 py-4 text-white uppercase text-sm font-bold rounded-full mr-8" href="#">Check Out Our Gallery</a>
                    <a class="border-2 border-white px-6 py-4 text-white uppercase text-sm font-bold rounded-full" href="#">Get In Touch</a>
                </div>
            </div>
        </div>
