...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex flex-col px-96 py-48 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            ...
            <p class="text-center text-xl text-gray-300">We pride ourselves in providing a safe space with a welcoming atmosphere for everyone to have fun!</p>
            <div class="flex items-center">
                <a class="bg-white rounded-md shadow-md text-sm px-6 py-3" href="#">Check Out Our Gallery</a>
            </div>
