                ...
                <div class="rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px; background-color: #111">
                    ...
                    <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                        <div class="flex items-start">
                            ...
                            <input class="flex-grow bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name">
                        </div>
                        ...
                        <div class="flex items-start mt-8">
                            ...
                            <textarea style="font-family: 'Nunito', sans-serif; height: 125px" class="resize-none flex-grow bg-black bg-opacity-50 p-3 rounded-md" name="name" id="name"></textarea>
                        </div>
                        <div class="flex flex-col items-end">
                            <button type="button" class="bg-blue-400 rounded-md mt-5 px-6 py-3 text-gray-600 uppercase font-semibold"><i class="fa fa-paper-plane mr-5"></i> Submit</button>
                        </div>
                    </form>
