        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-center px-96 h-screen" style="background-color: #201E1F">
                <div class="flex flex-col h-full w-1/2 text-gray-300 shadow-lg" style="height: 1000px;">
                    <div class="rounded-tl-3xl h-4/5 p-24" style="background-color: #111">
                        ...
                        <form class="contact-form" style="font-family: 'Roboto', sans-serif">
                            ...
                            <div class="flex items-center justify-between mt-8">
                                <div class="flex flex-col mr-5">
                                    <p class="text-gray-600 text-sm"><span class="italic text-yellow-100 font-bold mr-1">*</span> Required fields</p>
                    ...
                    <div class="rounded-bl-3xl h-1/5 px-24 flex flex-col justify-center text-3xl text-gray-600" style="background-color: #fff">
