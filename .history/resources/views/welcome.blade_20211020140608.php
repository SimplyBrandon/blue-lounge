                ...
                <div class="flex flex-col h-full w-1/2 text-gray-300 shadow-lg" style="height: 1000px;">
                    <div class="rounded-tl-3xl h-3/4 p-24" style="background-color: #111">
                        ...
                        <form class="contact-form" style="font-family: 'Roboto', sans-serif">
                            ...
                            <div class="flex flex-col mt-5">
                                <label class="font-light text-xl uppercase mb-3 tracking-widest" for="message">Email Address</label>
                                <textarea class="bg-white bg-opacity-5 px-4 py-4 shadow-md rounded-lg resize-none" style="height: 85px" type="text" name="message" id="message"></textarea>
                            </div>
                        </form>
                    </div>
