...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="bg-white py-24 px-96">
            ...
            <p>Located in the heart of Redcar, by the sea, we provide an unbeatable choice for any night out. Since 2013 we've seen to it that customers come in, have a great night and go home safely. We've <a href="#">recently introduced the option to have drinks with a lid and straw.</a></p>
        </div>
