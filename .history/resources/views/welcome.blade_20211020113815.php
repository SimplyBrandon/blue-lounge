                ...
                <div class="flex flex-col mt-12">
                    ...
                    <div class="flex items-center -mx-4">
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md" style="min-height: 260px">
                        ...
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md" style="min-height: 260px">
                                ...
                                <p class="font-bold italic mt-5 justify-self-end">~ Riley Hagen</p>
                            </div>
                        </div>
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md" style="min-height: 260px">
                                ...
                                <p class="font-bold italic mt-5 align-bottom">~ Craig Mcpherson</p>
                            </div>
                        </div>
                    </div>
                </div>
