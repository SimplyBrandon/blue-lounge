                    ...
                    <div class="flex items-center -mx-4">
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md">
                                <p class="leading-7">Tom and Ellie have delivered to excellent service. Such friendly and lovely people, helped me out when my phone was dead and helped me contact family members so I wasn’t on my own. Really appreciate their customer service, really friendly and polite. Couldn’t recommend anymore xx</p>
                                <p class="font-bold italic mt-5">~ Hollie Jones Dallas</p>
                            </div>
                        </div>
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md">
                                <p class="leading-7">Absolutely lovely staff, so kind and caring due to the government guidelines! Amazing atmosphere, put myself and friends at ease, showing everybody the new guidelines upon entry, table service is fast and friendly! Would recommend!</p>
                                <p class="font-bold italic mt-5">~ Nicole Martin</p>
                            </div>
                        </div>
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md">
                                <p class="leading-7">Very clear with new safety guidelines made me feel safe and comfortable while still providing great service and atmosphere, 10/10</p>
                                <p class="font-bold italic mt-5">~ Riley Hagen</p>
                            </div>
                        </div>
                        <div class="mx-4 w-1/4">
                            <div class="bg-gray-100 p-6 rounded-xl shadow-md">
                                <p class="leading-7">Thankyou All so much for saturday nite Private Party for my wifes 60th Birthday couldnt of asked for a better venue and thanks for putting all the decorations up nothing was too much bother and Ashley and All the Crew were Fantastic would definatley reccomend for any Party ❤😘👍🍾🥂xxx</p>
                                <p class="font-bold italic mt-5">~ Mike Thornton</p>
                            </div>
                        </div>
                    </div>
                </div>
