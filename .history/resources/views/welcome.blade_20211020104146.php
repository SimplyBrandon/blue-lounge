...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="bg-white py-16 px-96">
            <h2 class="text-2xl border-b-2 border-black pb-5 font-semibold text-white" style="font-family: 'Righteous', cursive"><span class="text-blue-400">blue</span> lounge</h2>
        </div>
