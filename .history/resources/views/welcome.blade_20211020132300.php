    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex items-start px-96 h-screen">
                <div class="bg-gray-900 rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300" style="height: 1000px">
                    <h2 class="text-white text-4xl font-light">Contact Form</h2>
                </div>

                <div class="flex flex-col h-full w-1/2 rounded-r-3xl items-center justify-center" style="height: 1000px; background-image: url('{{ asset('img/contact-bg.png') }}'); background-size: cover">
                    <iframe class="rounded-3xl" width="75%" height="75%" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCKJ5j9soePYzu_RWTE3GxkwJ2o7IA3PMY&q=Blue,Lounge,Redcar"></iframe>
                </div>

            </div>


            <div class="flex items-start px-96 pt-80 -mx-4 h-screen">
                <div class="flex flex-col w-1/2">
                    <div class="pr-24">
                        <div class="flex flex-col">
                            <h2 class="bg-gray-900 text-white px-8 py-6 rounded-t-md">Contact Form</h2>
                        </div>
                    </div>
                </div>
                <div class="rounded-3xl overflow-hidden w-1/2" style="background-image: url('{{ asset('img/contact-bg.png') }}')">
                    <div class="bg-white p-6 flex items-center rounded-b-3xl">
                        <i class="fa fa-map-pin mr-3"></i> <h2>96 High Street, Redcar, TS10 3DL</h2>
                    </div>
                </div>
            </div>
        </div>
