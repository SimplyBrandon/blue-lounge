            ...
            <div class="flex flex-col py-24 px-96 text-gray-300" style="background-color: #201E1F">
                ...
                <div class="flex flex-col mt-12">
                    ...
                    <div class="flex flex-col items-end justify-end mt-8">
                        <p class="text-sm font-semibold text-gray-500">The reviews above have been touched up, while the sentiments of the review remains the same. Only spelling, grammar and punctuation have been corrected.</p>
