        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-col items-center px-96 pt-80 h-screen parallax-window" data-parallax="scroll" data-image-src="{{ asset('img/website_bg.png') }}" style="background-size: cover;" >
                ...
                <div class="flex flex-col items-center justify-center mt-auto pb-16">
                    <div class="border-2 border-white rounded-full py-4 px-5 object">
            ...
            <div class="flex flex-col bg-white py-24 px-96">
                ...
                <div class="flex flex-col mt-12">
                    ...
                    <div class="flex items-center">
                        <div class="bg-gray-100 p-6 rounded-xl w-1/4 shadow-md">
                            <p class="leading-10">Tom and Ellie have delivered to excellent service. Such friendly and lovely people, helped me out when my phone was dead and helped me contact family members so I wasn’t on my own. Really appreciate their customer service, really friendly and polite. Wouldn’t recommend anymore xx</p>
