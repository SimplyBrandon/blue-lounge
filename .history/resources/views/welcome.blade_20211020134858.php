                ...
                <div class="rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px; background-color: #111">
                    ...
                    <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                        <div class="flex items-center">
                            <label class="font-semibold text-sm mb-2 uppercase text-white" style="width: 118px" for="name">Your Name</label>
                            <input class="bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name" placeholder="John Smith">
                        </div>
                        <div class="flex items-center mt-8">
                            <label class="font-semibold text-sm mb-2 uppercase text-white" style="width: 118px" for="name">The Subject</label>
                            <input class="bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name" placeholder="RE: Something or other">
                        </div>
                        <div class="flex items-center mt-8">
                            <label class="font-semibold text-sm mb-2 uppercase text-white" style="width: 118px" for="name">The Message</label>
