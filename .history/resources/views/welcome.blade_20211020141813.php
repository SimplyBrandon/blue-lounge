            ...
            <div class="flex items-start px-96 h-screen" style="background-color: #201E1F">
                <div class="flex flex-col h-full w-1/2 text-gray-300 shadow-lg" style="height: 1000px;">
                    <div class="rounded-tl-3xl h-4/5 p-24" style="background-color: #111">
                        ...
                        <form class="contact-form flex-grow" style="font-family: 'Roboto', sans-serif">
                            ...
                            <div class="flex flex-col flex-grow mt-5">
                                ...
                                <textarea class="flex-grow bg-white bg-opacity-5 px-4 py-4 shadow-md rounded-lg resize-none" style="height: 100px" type="text" name="message" id="message"></textarea>
                            </div>
