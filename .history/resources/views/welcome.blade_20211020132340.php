    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex items-start px-96 h-screen">
                ...
                <div class="flex flex-col h-full w-1/2 rounded-r-3xl items-center justify-center bg-gray-800" style="height: 1000px;">
                    <iframe class="rounded-3xl" width="100%" height="100%" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCKJ5j9soePYzu_RWTE3GxkwJ2o7IA3PMY&q=Blue,Lounge,Redcar"></iframe>
                </div>
