...
@section('content')
    <div class="flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center py-12 px-12" style="background: rgb(62,32,87); background: linear-gradient(180deg, rgba(62,32,87,1) 0%, rgba(17,24,39,1) 100%);">
            <img style="height: 100px; width: 100px" class="rounded-3xl shadow-md border-2 border-gray-300" src="https://scontent-lcy1-2.xx.fbcdn.net/v/t1.6435-9/84535118_2234335966869824_9114908075222892544_n.jpg?_nc_cat=109&ccb=1-5&_nc_sid=174925&_nc_ohc=PrEuIakgkSUAX-vH-My&_nc_oc=AQl756Ga_89dfl1ea04bhESo-M_UvA54eUZ44fY09oV9l0hgbeK2ZOpLk8ZycNZk9_Q&_nc_ht=scontent-lcy1-2.xx&oh=06b37e2e49cc5251256a60e1cdaee3e6&oe=619D74C0"/>
