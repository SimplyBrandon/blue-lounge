            ...
            <div class="flex flex-col bg-black bg-opacity-30 rounded-md mb-8 shadow-md">
                ...
                <div class="flex flex-col">
                    <div class="flex flex-col bg-white bg-opacity-5">
                        <h2>You're only supposed to blow the bloody doors off, not the whole building. Next time the building is blown up, there's going to be some serious problems.</h2>
