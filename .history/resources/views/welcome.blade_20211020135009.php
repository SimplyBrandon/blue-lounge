                ...
                <div class="rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px; background-color: #111">
                    ...
                    <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                        <div class="flex items-start">
                            ...
                            <input class="flex-grow bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name" placeholder="John Smith">
                        </div>
                        <div class="flex items-start mt-8">
                            <label class="font-semibold text-sm mt-3 uppercase text-white" style="width: 130px" for="name">The Subject</label>
                            <input class="flex-grow bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name" placeholder="RE: Something or other">
                        </div>
                        <div class="flex items-start mt-8">
                            <label class="font-semibold text-sm mt-3 uppercase text-white" style="width: 130px" for="name">The Message</label>
                            <textarea style="font-family: 'Nunito', sans-serif; height: 125px" class="resize-none flex-grow bg-black bg-opacity-50 p-3 rounded-md" name="name" id="name" placeholder="Enter your message here..."></textarea>
                        </div>
                    </form>
