...
background: linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(17,24,39,1) 100%);">
            ...
            <div class="flex flex-col ml-10">
                ...
                <h2 class="text-red-400 text-xl mt-1 tracking-wider flex items-center" style="font-family: 'Quicksand', sans-serif">Manager <span class="text-sm text-gray-300 ml-2">Since 25/10/2021</span></h2>
            </div>
        </div>
