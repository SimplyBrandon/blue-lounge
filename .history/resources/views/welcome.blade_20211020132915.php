                ...
                <div class="bg-gray-900 rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px">
                    ...
                    <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                        ...
                        <div class="flex flex-col mt-8">
                            <label class="font-semibold text-sm mb-2 uppercase text-white" for="name">Subject of your message</label>
                            <input class="bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name" placeholder="RE:Some sobject or other">
                        </div>
                    </form>
