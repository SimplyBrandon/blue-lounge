            ...
            <div class="flex flex-col py-24 px-96 text-gray-300" style="background-color: #201E1F">
                <div class="flex items-start">
                    <div class="flex flex-col text-left mr-24">
                        <h2 class="text-3xl text-white font-semibold mb-8">WHO WE ARE</h2>
                        ...
                        <p class="text-2xl text-blue-400 mt-10 leading-10">Blue lounge is the perfect place for unique and stunning cocktails in a beautiful setting with a speakeasy feel and live music from our resident DJ.</p>
                    </div>
                    <img class="w-1/2 rounded-3xl mb-10" src="{{ asset('img/banner.jpg') }}"/>
                </div>
                <div class="flex flex-col mt-12">
                    <h2 class="text-3xl font-semibold mb-8 text-white">But don't take our word for it...</h2>

                    <div class="flex items-center -mx-4">
                        <div class="flex flex-col mx-4 w-1/4">
                            <div class="flex flex-col bg-gray-100 bg-opacity-5 p-6 rounded-xl shadow-md" style="min-height: 260px">
                ...
                <div class="bg-gray-900 rounded-l-3xl flex flex-col h-full w-1/2 p-24 text-gray-300 shadow-lg" style="height: 1000px">
                    ...
                    <form class="contact-form" style="font-family: 'Nunito', sans-serif">
                        ...
                        <div class="flex flex-col mt-8">
                            <label class="font-semibold text-sm mb-2 uppercase text-white" for="name">The Subject</label>
                            <input class="bg-black bg-opacity-50 p-3 rounded-md" type="text" name="name" id="name" placeholder="RE: Something or other">
                        </div>
                        <div class="flex flex-col mt-8">
                            <label class="font-semibold text-sm mb-2 uppercase text-white" for="name">The Message</label>
                            <textarea style="font-family: 'Nunito', sans-serif; height: 280px" class="bg-black bg-opacity-50 p-3 rounded-md" name="name" id="name" placeholder="Enter your message here..."></textarea>
                        </div>
                    </form>
