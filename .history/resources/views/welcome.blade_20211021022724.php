        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-center px-96 h-screen" style="background-color: #201E1F">
                <div class="flex flex-col h-full w-1/2 text-gray-300 shadow-lg" style="height: 1000px;">
                    ...
                    <div class="rounded-bl-3xl rounded-br-3xl h-1/5 px-36 flex flex-col justify-center text-3xl text-white border-2 border-t-0 border-gray-800" style="background-color: #000">
