        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-wrap px-96 pt-80 -mx-4 h-screen parallax-window" data-parallax="scroll" data-image-src="{{ asset('img/website_bg_2.png') }}" style="background-size: cover;" >
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=1"/>
                    </div>
                </div>
                <div class="flex flex-col w-2/3">
                    <div class="mx-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=2"/>
                    </div>
                </div>
                <div class="flex flex-col w-2/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=3"/>
                    </div>
                </div>
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=4"/>
                    </div>
                </div>
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=5"/>
                    </div>
                </div>
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=6"/>
                    </div>
                </div>
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=7"/>
                    </div>
                </div>
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=8"/>
                    </div>
                </div>
                <div class="flex flex-col w-2/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 300px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/300/200?random=9"/>
                    </div>
                </div>
            </div>
        </div>
