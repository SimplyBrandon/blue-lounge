    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex items-start bg-white py-24 px-96">
            <div class="flex flex-col text-left mr-24">
                ...
                <p class="text-2xl mt-10">Blue lounge is the perfect place for unique and stunning cocktails in a beautiful setting with a speakeasy feel and live music from our resident DJ.</p>
            </div>
