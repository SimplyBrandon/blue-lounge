                        ...
                        <form class="contact-form" style="font-family: 'Roboto', sans-serif">
                            <div class="flex items-center">
                                <div class="flex flex-col w-1/2 mr-2">
                                    ...
                                    <input class="bg-white bg-opacity-5 px-4 py-3 shadow-md" type="text" name="first_name" id="first_name">
                                </div>
                                <div class="flex flex-col w-1/2 ml-2">
                                    ...
                                    <input class="bg-white bg-opacity-5 px-4 py-3 shadow-md" type="text" name="last_name" id="last_name">
                                </div>
                            </div>
                        </form>
                    </div>
