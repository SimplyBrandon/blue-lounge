                ...
                <div class="flex flex-col w-full">
                    <table class="w-full">
                        <thead class="bg-white bg-opacity-5">
                            <tr>
                                <th class="text-left text-white p-3">Date</th>
                                <th class="text-left text-white p-3">Expected Hours</th>
                                <th class="text-left text-white p-3">Clocked Hours</th>
                                <th class="text-left text-white p-3 text-right">Daily Earnings</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
