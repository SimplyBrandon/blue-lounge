            ...
            <div class="flex flex-col w-full bg-white bg-opacity-5 rounded-md p-10">
                ...
                <div class="flex flex-col w-full">
                    <table>
                        <thead>
                            <tr>
                                <th class="text-left text-white py-3 px-4">Date</th>
                                <th class="text-left text-white py-3 px-4">Expected Hours</th>
                                <th class="text-left text-white py-3 px-4">Clocked Hours</th>
                                <th class="text-left text-white py-3 px-4">Daily Earnings</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
