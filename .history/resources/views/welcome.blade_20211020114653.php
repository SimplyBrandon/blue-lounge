            ...
            <div class="flex flex-col bg-white py-24 px-96">
                ...
                <div class="flex flex-col mt-12">
                    ...
                    <div class="flex flex-col items-end justify-end mt-5">
                        ...
                        <a class="text-sm uppercase font-semibold" href="https://www.facebook.com/BlueLoungeRed/reviews/?ref=page_internal">View Original <i class="fa fa-caret-right ml-3"></i></a>
                    </div>
                </div>
            </div>
        </div>
