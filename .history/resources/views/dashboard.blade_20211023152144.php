        ...
        <div class="flex flex-col flex-grow mr-10">
            <div class="flex flex-col bg-black bg-opacity-30 rounded-md mb-8 shadow-md">
                ...
                <div class="flex flex-col">
                    <div class="flex flex-col bg-white bg-opacity-5">
                        <h2 class="text-white">You're only supposed to blow the bloody doors off, not the whole building. Next time the building is blown up, there's going to be some serious problems.</h2>
                        <h2>~ Brandon Rooney</h2>
                    </div>
                </div>
            </div>
