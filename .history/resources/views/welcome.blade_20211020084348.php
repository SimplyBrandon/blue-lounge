...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex items-start justify-between px-96 py-64 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            <div class="flex items-center justify-between w-full">
                <div class="flex flex-col">
                    <h2 class="text-white mb-5 text-3xl font-bold uppercase tracking-wide">Welcome to Blue Lounge</h2>
                    <p class="text-xl text-gray-300 mb-5">Since we opened in 2001 we've cultivated a unique and friendly environment with modern decor, a resident DJ and events.</p>
                ...
                <div class="flex">
                    <a class="border-2 border-white px-6 py-4 text-white uppercase text-sm font-semibold rounded-full mr-8" href="#">Check Out Our Gallery</a>
                    <a class="border-2 border-white px-6 py-4 text-white uppercase text-sm font-semibold rounded-full" href="#">Get In Touch</a>
                </div>
            </div>
        </div>
