    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <header class="absolute w-full flex items-center justify-between py-10 px-96">
            ...
            <nav class="flex items-center">
                <a class="text-lg uppercase text-gray-300 mr-5" href="#">About</a>
                <a class="text-lg uppercase  text-gray-300 mr-5" href="#">Gallery</a>
                <a class="text-lg uppercase  text-gray-300 mr-10" href="#">Events</a>
                <a class="px-5 py-3 text-lg uppercase  text-black bg-white font-bold rounded-md" href="#">Get In Touch</a>
            </nav>
        </header>
