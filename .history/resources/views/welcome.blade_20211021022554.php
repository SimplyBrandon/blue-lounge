...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-800" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            <header class="absolute w-full flex items-center justify-between py-16 px-96 transition ease-in-out duration-200">
            ...
            <div class="flex flex-col pt-32 px-96 text-gray-300" style="background-color: #201E1F">
            ...
            <div class="flex items-center px-96 h-screen" style="background-color: #201E1F">
                <div class="flex flex-col h-full w-1/2 text-gray-300 shadow-lg" style="height: 1000px;">
                    <div class="rounded-tl-3xl h-4/5 p-24 bg-black border-2 border-r-0 border-b-0 border-gray-800 bg-opacity-20">
                        ...
                        <form class="contact-form" style="font-family: 'Roboto', sans-serif">
                            <div class="flex items-center">
                                <div class="flex flex-col w-1/2 mr-4">
                                    <label class="font-light text-xl uppercase mb-3 tracking-widest" for="first_name">First Name <span class="italic text-yellow-100 font-bold">*</span></label>
                            ...
                            <div class="flex flex-col mt-5">
                                <label class="font-light text-xl uppercase mb-3 tracking-widest" for="email_address">Email Address <span class="italic text-yellow-100 font-bold">*</span></label>
                                <input class="bg-white bg-opacity-5 px-4 py-4 shadow-md rounded-lg" type="text" name="email_address" id="email_address">
                            </div>
                            <div class="flex flex-col mt-5">
                                <label class="font-light text-xl uppercase mb-3 tracking-widest" for="message">Message <span class="italic text-yellow-100 font-bold">*</span></label>
                                <textarea class="bg-white bg-opacity-5 px-4 py-4 shadow-md rounded-lg resize-none" style="height: 140px" type="text" name="message" id="message"></textarea>
                            </div>
                            <div class="flex items-center justify-between mt-8">
                                <div class="flex flex-col mr-5">
                                    <p class="text-gray-600 text-sm"><span class="italic text-yellow-100 font-bold mr-2">*</span> Required fields</p>
                                    <p class="text-gray-500 text-sm">By submitting a message you agree to our <a class="text-gray-300 font-semibold italic" href="#">Privacy Policy</a> and <a class="text-gray-300 font-semibold italic" href="#">Terms of Service</a></p>
                                </div>
                    ...
                    <div class="rounded-bl-3xl h-1/5 px-24 flex flex-col justify-center text-3xl text-white border-2 border-t-0 border-r-0 border-gray-800" style="background-color: #000">
                        <p class="text-base uppercase tracking-widest mb-5">Connect On Social Media</p>
                        <div class="flex items-center">
                            <a class="mr-5" href="#"><i class="fab fa-facebook"></i></a>
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col h-full w-1/2 rounded-r-3xl py-24 items-center justify-center bg-gray-800 shadow-lg" style="height: 1000px;">
            ...
            {{-- <div class="flex flex-col bg-black px-96 py-12">
                <div class="flex items-start justify-between">
                    <div class="flex flex-col">
                        <h2 class="font-bold text-white mb-5" style="font-family: 'Righteous', cursive"><span class="text-blue-400 text-2xl">blue</span> LOUNGE</h2>
                        <p class="text-gray-300 leading-7 text-md tracking-wide" style="width: 205px">Redcar's finest cocktail bar is ready to provide you with an outing you won't forget!</p>

                        <h2 class="mt-8 text-gray-500">&copy; <span style="font-family: 'Righteous', cursive">blue lounge</span> 2021</h2>
                    </div>
                    <div class="flex flex-col text-gray-300" style="font-family: 'Quicksand', sans-serif">
                        <h2 class="mb-5 text-white font-bold text-md">Quick Links</h2>
                        <a href="#">Drink Prices</a>
                        <a href="#">Support</a>
                        <a href="#">Staff Portal</a>
                    </div>
                    <div class="flex flex-col">
                        <h2 class="text-gray-200">Subscribe to our newsletter</h2>
                        <div class="flex items-center">
                            <input type="email" name="email_subscribe" placeholder="Your email address...">
                            <button type="button"><i class="text-white fa fa-newspaper"></i></button>
                        </div>
                    </div>
                </div>
            </div> --}}
