            ...
            <div class="flex flex-col bg-black bg-opacity-30 rounded-md mb-8 shadow-md">
                <div class="flex items-center w-full px-6 py-4 text-white text-sm font-semibold uppercase tracking-wider" style="font-family: 'Roboto', sans-serif">
                    ...
                    <div class="flex items-center ml-auto">
                        ...
                        <button type="button" id="next-announcement" class="uppercase font-semibold text-gray-500" next-announcement>Next</button>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            $('[next-announcement]:not(.disabled)').on('click', function(){
                ...
                if(announcementsLeftPos == $('#staff-announcements').outerWidth()){
                    $('[next-announcement]').addClass('disabled');
                } else {
                    $('[prev-announcement].disabled').removeClass('disabled');
                }
            });
            ...
            $('[prev-announcement].not(.disabled)').on('click', function(){
                ...
                if(announcementsLeftPos == 0){
                    $('[prev-announcement]').addClass('disabled');
                } else {
                    $('[next-announcement].disabled').removeClass('disabled');
                }
            });
        });
