...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex items-start px-96 pt-80 -mx-4 h-screen parallax-window" data-parallax="scroll" data-image-src="{{ asset('img/website_bg_2.png') }}" style="background-size: cover;" >
                ...
                <div class="rounded-3xl overflow-hidden w-1/2">
