        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-start px-96 h-screen" style="background-color: #201E1F">
                <div class="flex flex-col h-full w-1/2 text-gray-300 shadow-lg" style="height: 1000px;">
                    <div class="rounded-tl-3xl h-2/3 p-24" style="background-color: #111">
                    ...
                    <div class="rounded-bl-3xl h-1/3 p-24" style="background-color: #222">
                        <button type="button" class="bg-blue-400 rounded-3xl w-full py-3 mb-5">
                            <h2 class="text-white font-semibold tracking-wide"><i class="fab fa-facebook mr-3"></i> Facebook</h2>
                        </button>
                        <button type="button" style="background-color: #3f729b" class="rounded-3xl w-full py-3">
                            <h2 class="text-white font-semibold tracking-wide"><i class="fab fa-instagram mr-3"></i> Instagram</h2>
                        </button>
                    </div>
                </div>
