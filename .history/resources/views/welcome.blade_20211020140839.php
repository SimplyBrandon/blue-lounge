                    ...
                    <div class="rounded-tl-3xl h-3/4 p-24" style="background-color: #111">
                        ...
                        <form class="contact-form" style="font-family: 'Roboto', sans-serif">
                            ...
                            <div class="flex flex-col items-end mt-8">
                                <button type="button" class="rounded-md bg-white bg-opacity-10 hover:bg-opacity-20 transition ease duration-200 px-6 py-3 text-white"><i class="fa fa-paper-plane mr-3"></i> Submit</button>
                            </div>
                        </form>
                    </div>
