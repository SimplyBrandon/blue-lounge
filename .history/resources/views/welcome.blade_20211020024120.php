...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <header class="bg-gray-900 absolute w-full flex items-center justify-between py-10 px-96">
            <div class="flex items-center" style="font-family: 'Brimstone', cursive">
                <h2 class="mr-2 text-2xl text-blue-400 font-semibold">Blue</h2>
                <h2 class="text-2xl text-black font-semibold">Lounge</h2>
            </div>
        </header>
