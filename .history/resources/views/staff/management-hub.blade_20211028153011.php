...
@section('content')
    <div class="flex flex-col max-w-7xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-10">
            <div class="flex items-center w-1/3 bg-gray-800 hover:bg-gray-900 rounded-md shadow-md p-6 cursor-pointer text-gray-400 hover:text-gray-300 transition ease duration-200">
