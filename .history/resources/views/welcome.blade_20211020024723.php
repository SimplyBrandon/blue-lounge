    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <header class="absolute w-full flex items-center justify-between py-10 px-96">
            ...
            <nav class="flex items-center">
                <a class="font-semibold text-2xl text-gray-300 mr-5" href="#">About</a>
                <a class="font-semibold text-2xl text-gray-300 mr-5" href="#">Gallery</a>
                <a class="font-semibold text-2xl text-gray-300 mr-5" href="#">Events</a>
                <a class="font-semibold text-2xl text-gray-300" href="#">Get In Touch</a>
            </nav>
        </header>
