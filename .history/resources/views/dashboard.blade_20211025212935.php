...
@section('content')
    <div class="flex flex-col max-w-7xl mx-auto px-4 pt-10 sm:px-6 lg:px-8">
        <div class="flex items-center" style="background: rgb(62,32,87); background: linear-gradient(180deg, rgba(62,32,87,1) 0%, rgba(17,24,39,1) 100%);">
