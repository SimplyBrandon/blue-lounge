...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex flex-col items-center px-96 pt-80 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            ...
            <h2 class="mt-24 text-2xl font-light text-gray-300"><i class="fa fa-map-pin mr-5"></i> 96 High Street, TS10 3DL, Redcar</h2>01642 756284
            <h2 class="mt-3 text-2xl font-light text-gray-300"><i class="fa fa-map-pin mr-5"></i> 96 High Street, TS10 3DL, Redcar</h2>01642 756284
            <h2 class="mt-3 text-sm uppercase font-bold text-red-400">Currently Closed - Opens at 12PM</h2>
