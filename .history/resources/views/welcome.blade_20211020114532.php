            ...
            <div class="flex flex-col bg-white py-24 px-96">
                ...
                <div class="flex flex-col mt-12">
                    ...
                    <div class="flex flex-col items-end justify-end">
                        <p>The reviews above have been touched up, while the sentiments of the review remains the same. Only spelling, grammar and punctuation have been corrected.</p>
