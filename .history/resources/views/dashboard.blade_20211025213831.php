            ...
            <div class="flex items-center mb-10 gap-4">
                <div class="flex items-center bg-white bg-opacity-5 rounded-md p-6 w-1/3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <h2 class="text-sm uppercase text-gray-500">Total Hours Clocked</h2>
                    </div>
                </div>
                <div class="flex items-center bg-white bg-opacity-5 rounded-md p-6 w-1/3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <h2 class="text-sm uppercase text-gray-500">Total Earnings</h2>
                    </div>
                </div>
                <div class="flex items-center bg-white bg-opacity-5 rounded-md p-6 w-1/3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <h2 class="text-sm uppercase text-gray-500">Total Days Worked</h2>
                    </div>
                </div>
            </div>
