    ...
    <div class="flex items-start max-w-7xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col w-1/3">
            <div class="flex flex-col bg-blue-400 bg-opacity-20 items-center justify-center p-10" style="font-family: 'Quicksand', sans-serif">
                <h1 class="font-semibold text-4xl text-white tracking-wider" style="font-family: 'Bebas Neue', sans-serif">Ready for your shift?</h1>
                ...
                <button type="button" class="bg-blue-400 hover:bg-blue-500 w-full mt-10 py-3 text-white text-sm uppercase font-semibold tracking-wide rounded-md shadow-md">Start your shift</button>
            </div>
        </div>
    </div>
@endsection