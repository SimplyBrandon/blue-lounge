    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex flex-col bg-black px-96 py-12">
                <div class="flex items-start">
                    <div class="flex flex-col">
                        <h2 class="font-bold text-white" style="font-family: 'Righteous', cursive"><span class="text-blue-400 text-2xl">blue</span> LOUNGE</h2>
                        <p class="text-gray-200">Redcar's finest cocktail bar is ready to provide you with an experience you won't forget!</p>
                    </div>
                </div>
            </div>
        </div>
