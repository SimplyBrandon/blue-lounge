...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        <div class="flex flex-col">
            ...
            <div class="flex flex-wrap px-96 pt-80 -mx-4 h-screen parallax-window" data-parallax="scroll" data-image-src="{{ asset('img/website_bg_2.png') }}" style="background-size: cover;" >
                ...
                <div class="flex flex-col w-2/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 200px">
                        <img class="w-full h-full rounded-lg" src="https://picsum.photos/200/400?random=3"/>
                    </div>
                </div>
                <div class="flex flex-col w-1/3">
                    <div class="mx-4 mt-4 h-full" style="max-height: 200px">
