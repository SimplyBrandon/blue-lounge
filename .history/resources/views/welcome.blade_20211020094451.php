    ...
    <body class="antialiased" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex flex-col items-center justify-center px-96 py-36 h-screen" style="background-image: url('{{ asset('img/website_bg.png') }}'); background-size: cover;">
            <div class="flex items-center text-white text-6xl mb-24">
                <img style="height: 185px" class="mr-12" src="{{ asset('img/star.png') }}"/>
                <img style="height: 185px" class="mr-12" src="{{ asset('img/star.png') }}"/>
                <img style="height: 185px" class="mr-12" src="{{ asset('img/star.png') }}"/>
                <img style="height: 185px" class="mr-12" src="{{ asset('img/star.png') }}"/>
                <img style="height: 185px" class="mr-12" src="{{ asset('img/half-star.png') }}"/>
            </div>
            <h2 style="font-family: 'Bebas Neue', sans-serif" class="text-6xl text-white tracking-wider">A unique cocktail bar providing a lovely and cultivated environment.</h2>
            <h2 style="font-family: 'Bebas Neue', sans-serif" class="text-6xl text-white tracking-wider">Renowned for our friendly staff, resident DJ and varied drink selection</h2>
        </div>
